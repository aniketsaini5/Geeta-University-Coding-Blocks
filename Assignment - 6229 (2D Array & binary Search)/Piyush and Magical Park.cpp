...

// 1. **Input lena:** `N`, `M`, `K`, aur `S` ki values input lo.
//    - `N` aur `M` represent the dimensions of the parking lot grid.
//    - `K` is the minimum strength needed to successfully escape.
//    - `S` is the initial strength of the person.

// 2. **Parking lot grid banana:** `N x M` ki ek char array `park` banaiye.
//    - Har cell ko fill karo according to input (`.` for empty space, `*` for energy boost, `#` for obstacle).

// 3. **Escape possibility check karna:**
//    - `escape` ko `true` initialize karo.
//    - Har row ke liye (0 se N-1 tak):
//      - Agar `S` less than `K` hai:
//        - `escape` ko `false` set karo aur loop se bahar nikalo.
//      - Har column ke liye (0 se M-1 tak):
//        - Agar cell me `.` hai:
//          - `S` se 2 strength kam karo (`S -= 2`).
//        - Agar cell me `*` hai:
//          - `S` me 5 strength add karo (`S += 5`).
//        - Agar cell me `#` hai:
//          - Loop se bahar nikalo (`break`).
//        - Agar column ka last element nahi hai (`j != M-1`):
//          - `S` se 1 strength kam karo (`S--`).
//    - Agar `escape` true hai:
//      - "Yes" print karo.
//      - `S` ki value print karo.
//    - Otherwise:
//      - "No" print karo.

// Yeh code simulate karta hai ki kya person given strength `S` ke saath parking lot se successfully escape kar sakta hai ya nahi, taking into account different types of cells (`.` for empty, `*` for energy boost, `#` for obstacle).
